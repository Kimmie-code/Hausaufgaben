...
public class Hausaufgabe2 {
    public static void main(String[] args) {
        ...
        System.out.println("Bitte Anlagesumme: ");
        Anlagensumme = Keyb.nextFloat();
        System.out.println("Bitte Zinssatz eingeben: ");
        Zinssatz = Keyb.nextFloat();
        System.out.println("Bitte Laufzeit eingeben: ");
        Laufzeit = Keyb.nextInt();

        System.out.println("Bei einer Anlagensumme von " + Anlagensumme + " Euro und bei einem Zinssatz von " + Zinssatz
                + "% ergibt sich folgendes Sparvermögen:");
