...
public class spiel21 {
    public static void main(String[] args) {
        ...
        System.out.print("Wieviele Striche sollen am Bildschirm ausgegeben werden: ");
        zahl_strich = Keyb.nextInt();
        ...
        while (zahl_strich > 0) {
            ...
            System.out.print("\nWie viele Streichhoelzer nimmst du ? ");
            nimm = Keyb.nextInt();

            while ((nimm > 4) || (nimm <= 0)) {

                System.out.println(+nimm + " Hoelzer duerfen nicht genommen werden");
                System.out.println("\nWieviele Hoelzer nimmst du wirklich?");
                nimm = Keyb.nextInt();
